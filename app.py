...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(90, 120, 69, 24))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.comboBox_toa_do = QtWidgets.QComboBox(parent=self.centralwidget)
        self.comboBox_toa_do.setGeometry(QtCore.QRect(190, 111, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_toa_do.setItemText(1, _translate("MainWindow", "Tokyo"))
        self.comboBox_toa_do.setItemText(2, _translate("MainWindow", "Berlin"))
        self.comboBox_toa_do.setItemText(3, _translate("MainWindow", "London"))
        self.comboBox_toa_do.setItemText(4, _translate("MainWindow", "Paris"))
        self.comboBox_toa_do.setItemText(5, _translate("MainWindow", "Ottawa"))
        self.comboBox_toa_do.setItemText(6, _translate("MainWindow", "Seoul"))
        self.comboBox_toa_do.setItemText(7, _translate("MainWindow", "Washington, D.C."))
        self.comboBox_toa_do.setItemText(8, _translate("MainWindow", "Bắc Kinh"))
        self.comboBox_toa_do.setItemText(9, _translate("MainWindow", "TP HCM"))
